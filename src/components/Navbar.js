...
const Navbar = () => {
  useEffect(() => {
    ...
    const elementosNav = [cerrar, inicio, contacto, nosotros, carrito];
    ...
    const flechaAbreCatAlimento = document.querySelector(
      "#flechaAbreCatAlimento"
    );
    const flechaCierreCatAlimento = document.querySelector(
      "#flechaCierreCatAlimento"
    );
    const flechaAbreCatMarca = document.querySelector("#flechaAbreCatMarca");
    const flechaCierreCatMarca = document.querySelector(
      "#flechaCierreCatMarca"
    );
    const opcionesCategoriaAlimento = document.querySelector(
      "#opcionesCategoriaAlimento"
    );
    const opcionesCategoriaMarca = document.querySelector(
      "#opcionesCategoriaMarca"
    );
          ...
          <ul>
            ...
            <ul className="contenedorCategorias">
              ...
              <ul id="categorias" className="categorias oculto">
                <li>
                  <button id="flechaAbreCatAlimento">
                    Alimento
                    <i className="bi bi-caret-down"></i>
                  </button>
                  <button id="flechaCierreCatAlimento" className="oculto">
                    Alimento
                ...
                <li>
                  <button id="flechaAbreCatMarca">
                  Marcas
                    <i className="bi bi-caret-down"></i>
                  </button>
                  <button id="flechaCierreCatMarca" className="oculto">
                  Marcas
                    <i
                ...
                <li className="catElegida">
                  <Link className="catJuguetes" to={"/productos/juguetes"}>
                    Juguetes
                  </Link>
                </li>
              </ul>
